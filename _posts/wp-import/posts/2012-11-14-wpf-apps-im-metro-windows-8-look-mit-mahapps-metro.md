...
<p><a href="{{BASE_PATH}}/assets/wp-images/image1656.png"><img title="image" style="border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; display: inline" border="0" alt="image" src="{{BASE_PATH}}/assets/wp-images/image_thumb814.png" width="479" height="218"></a> </p>
...
<p>Erstes Ergebnis:</p>
<p><a href="{{BASE_PATH}}/assets/wp-images/image1657.png"><img title="image" style="border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; display: inline" border="0" alt="image" src="{{BASE_PATH}}/assets/wp-images/image_thumb815.png" width="446" height="298"></a> </p>
