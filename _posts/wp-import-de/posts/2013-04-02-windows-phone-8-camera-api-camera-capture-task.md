...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image1803.png"><img title="image" style="border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; display: inline" border="0" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image_thumb957.png" width="155" height="240"></a> </p>
...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image1804.png"><img title="image" style="border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px; display: inline" border="0" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image_thumb958.png" width="583" height="266"></a> </p>
