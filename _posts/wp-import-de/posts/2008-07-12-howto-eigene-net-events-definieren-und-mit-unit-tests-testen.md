...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image488.png"><img style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" height="154" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb467.png" width="201" border="0"></a> </p>
