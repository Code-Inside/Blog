...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image834.png"><img style="border-right: 0px; border-top: 0px; margin: 0px 10px 0px 0px; border-left: 0px; border-bottom: 0px" height="104" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image_thumb19.png" width="244" align="left" border="0"></a>Die Daten kommen als Parameter an und ich füge dem ModelState "Errors" hinzu. Wichtig ist der Key. Dieser muss mit dem "Key" des Html Feldes übereinstimmen.</p>
...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image835.png"><img style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" height="227" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image_thumb20.png" width="398" border="0"></a> </p>
<p>Neben der Fehlermeldung wird auch der alte Wert wieder übermittelt:</p>
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image836.png"><img style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" height="244" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image_thumb21.png" width="234" border="0"></a> </p>
...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image837.png"><img style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" height="188" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image_thumb22.png" width="244" border="0"></a> </p>
...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image838.png"><img style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" height="78" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image_thumb23.png" width="244" border="0"></a> </p>
...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image839.png"><img style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" height="192" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image_thumb24.png" width="494" border="0"></a> </p>
