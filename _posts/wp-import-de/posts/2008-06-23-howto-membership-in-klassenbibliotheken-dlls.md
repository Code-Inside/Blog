...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image473.png"><img style="border-right: 0px; border-top: 0px; border-left: 0px; border-bottom: 0px" height="162" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb452.png" width="244" border="0"></a> </p>
<p>Jetzt fügen wir noch die "System.Web" Referenz hinzu:</p>
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image474.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="206" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb453.png" width="244" border="0"></a> </p>
