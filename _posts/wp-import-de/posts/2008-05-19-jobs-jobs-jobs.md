...
---
{% include JB/setup %}
<p style="text-align: center"> <img src="{{BASE_PATH}}/assets/wp-images-de/mitarbeiterwerben.jpg" onclick="window.location ='{{BASE_PATH}}/assets/wp-images-de/mitarbeiterwerben.jpg'; " style="border: 0px none " alt="mitarbiter werben" /></p>
