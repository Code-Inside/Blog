...
<p>I wrote this article to transmit the basic idea to you and to show you how easy it would be to implement this at the beginning of every project.</p> <!--more--><strong>What kind of Layers and why 3? </strong>  
  <p><strong></strong></p>
