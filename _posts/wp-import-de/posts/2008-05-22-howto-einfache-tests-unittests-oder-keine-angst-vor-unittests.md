...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image412.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="196" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb391.png" width="244" border="0"></a> </p>
<p>Jetzt können wir diesen Test durchlaufen und sehen:</p>
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image413.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="114" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb392.png" width="341" border="0"></a> </p>
...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image414.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="78" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb393.png" width="244" border="0"></a> </p>
<p>Ergebnis:</p>
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image415.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="115" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb394.png" width="322" border="0"></a> </p>
<p>Schön, oder? :)</p>
...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image416.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="60" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb395.png" width="300" border="0"></a> </p>
<p>Ergebnis:</p>
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image417.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="102" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb396.png" width="578" border="0"></a> </p>
<p>Fail!</p>
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image418.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="183" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb397.png" width="244" border="0"></a></p>
...
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image419.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="57" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb398.png" width="414" border="0"></a> </p>
<p>Resultat beim Entwickler (&amp; beim zufriedenen Kunden) :</p>
<p><a href="{{BASE_PATH}}/assets/wp-images-de/image420.png"><img style="border-top-width: 0px; border-left-width: 0px; border-bottom-width: 0px; border-right-width: 0px" height="244" alt="image" src="{{BASE_PATH}}/assets/wp-images-de/image-thumb399.png" width="178" border="0"></a> </p>
<p>Der Testcode:</p>
